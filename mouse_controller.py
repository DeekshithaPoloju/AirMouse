...
class MouseController:
    ...
    def stop_drag(self):
        if self.dragging:
            pyautogui.mouseUp()
            self.dragging = False
            self.dragging = Falseself.dragging = Falseself.dragging = Falseself.dragging = Falseself.dragging = Falseself.dragging = Falseself.dragging = Falseself.dragging = False